...
SEXP CallCascade(SEXP s_pop,
	...
	SET_VECTOR_ELT(sOUT,65,sGuidelines_PopDist_500_DiagNotInCareNeverCare);
	SET_VECTOR_ELT(sOUT,66,sGuidelines_PopDist_500_DiagNotInCareNeverCareEligible);
	SET_VECTOR_ELT(sOUT,67,sGuidelines_PopDist_500_DiagNotInCareEverCare);
	SET_VECTOR_ELT(sOUT,68,sGuidelines_PopDist_500_DiagNotInCareEverCareEligible);
	SET_VECTOR_ELT(sOUT,69,sGuidelines_PopDist_500_InCareNeverArtNeverCd4Result);
	SET_VECTOR_ELT(sOUT,70,sGuidelines_PopDist_500_InCareNeverArtLessTwoCd4Test);
	SET_VECTOR_ELT(sOUT,71,sGuidelines_PopDist_500_InCareNeverArtMoreTwoCd4Test);
	SET_VECTOR_ELT(sOUT,72,sGuidelines_PopDist_500_ArtAtEnrollmentLessSixMonths);
	SET_VECTOR_ELT(sOUT,73,sGuidelines_PopDist_500_ArtAtEnrollmentMoreSixMonths);
	SET_VECTOR_ELT(sOUT,74,sGuidelines_PopDist_500_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,75,sGuidelines_PopDist_500_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,76,sGuidelines_PopDist_500_OffArt);
	SET_VECTOR_ELT(sOUT,77,sGuidelines_PopDist_350500_NeverDiag);
	SET_VECTOR_ELT(sOUT,78,sGuidelines_PopDist_350500_DiagNotInCareNeverCare);
	SET_VECTOR_ELT(sOUT,79,sGuidelines_PopDist_350500_DiagNotInCareNeverCareEligible);
	SET_VECTOR_ELT(sOUT,80,sGuidelines_PopDist_350500_DiagNotInCareEverCare);
	SET_VECTOR_ELT(sOUT,81,sGuidelines_PopDist_350500_DiagNotInCareEverCareEligible);
	SET_VECTOR_ELT(sOUT,82,sGuidelines_PopDist_350500_InCareNeverArtNeverCd4Result);
	SET_VECTOR_ELT(sOUT,83,sGuidelines_PopDist_350500_InCareNeverArtLessTwoCd4Test);
	SET_VECTOR_ELT(sOUT,84,sGuidelines_PopDist_350500_InCareNeverArtMoreTwoCd4Test);
	SET_VECTOR_ELT(sOUT,85,sGuidelines_PopDist_350500_ArtAtEnrollmentLessSixMonths);
	SET_VECTOR_ELT(sOUT,86,sGuidelines_PopDist_350500_ArtAtEnrollmentMoreSixMonths);
	SET_VECTOR_ELT(sOUT,87,sGuidelines_PopDist_350500_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,88,sGuidelines_PopDist_350500_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,89,sGuidelines_PopDist_350500_OffArt);
	SET_VECTOR_ELT(sOUT,90,sGuidelines_PopDist_200350_NeverDiag);
	SET_VECTOR_ELT(sOUT,91,sGuidelines_PopDist_200350_DiagNotInCareNeverCare);
	SET_VECTOR_ELT(sOUT,92,sGuidelines_PopDist_200350_DiagNotInCareNeverCareEligible);
	SET_VECTOR_ELT(sOUT,93,sGuidelines_PopDist_200350_DiagNotInCareEverCare);
	SET_VECTOR_ELT(sOUT,94,sGuidelines_PopDist_200350_DiagNotInCareEverCareEligible);
	SET_VECTOR_ELT(sOUT,95,sGuidelines_PopDist_200350_InCareNeverArtNeverCd4Result);
	SET_VECTOR_ELT(sOUT,96,sGuidelines_PopDist_200350_InCareNeverArtLessTwoCd4Test);
	SET_VECTOR_ELT(sOUT,97,sGuidelines_PopDist_200350_InCareNeverArtMoreTwoCd4Test);
	SET_VECTOR_ELT(sOUT,98,sGuidelines_PopDist_200350_ArtAtEnrollmentLessSixMonths);
	SET_VECTOR_ELT(sOUT,99,sGuidelines_PopDist_200350_ArtAtEnrollmentMoreSixMonths);
	SET_VECTOR_ELT(sOUT,100,sGuidelines_PopDist_200350_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,101,sGuidelines_PopDist_200350_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,102,sGuidelines_PopDist_200350_OffArt);
	SET_VECTOR_ELT(sOUT,103,sGuidelines_PopDist_200_NeverDiag);
	SET_VECTOR_ELT(sOUT,104,sGuidelines_PopDist_200_DiagNotInCareNeverCare);
	SET_VECTOR_ELT(sOUT,105,sGuidelines_PopDist_200_DiagNotInCareNeverCareEligible);
	SET_VECTOR_ELT(sOUT,106,sGuidelines_PopDist_200_DiagNotInCareEverCare);
	SET_VECTOR_ELT(sOUT,107,sGuidelines_PopDist_200_DiagNotInCareEverCareEligible);
	SET_VECTOR_ELT(sOUT,108,sGuidelines_PopDist_200_InCareNeverArtNeverCd4Result);
	SET_VECTOR_ELT(sOUT,109,sGuidelines_PopDist_200_InCareNeverArtLessTwoCd4Test);
	SET_VECTOR_ELT(sOUT,110,sGuidelines_PopDist_200_InCareNeverArtMoreTwoCd4Test);
	SET_VECTOR_ELT(sOUT,111,sGuidelines_PopDist_200_ArtAtEnrollmentLessSixMonths);
	SET_VECTOR_ELT(sOUT,112,sGuidelines_PopDist_200_ArtAtEnrollmentMoreSixMonths);
	SET_VECTOR_ELT(sOUT,113,sGuidelines_PopDist_200_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,114,sGuidelines_PopDist_200_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,115,sGuidelines_PopDist_200_OffArt);
	SET_VECTOR_ELT(sOUT,116,sGuidelines_Death_HivNegative);
	SET_VECTOR_ELT(sOUT,117,sGuidelines_Death_500_NeverDiag);
	SET_VECTOR_ELT(sOUT,118,sGuidelines_Death_500_DiagNotInCare);
	SET_VECTOR_ELT(sOUT,119,sGuidelines_Death_500_InCareNeverArt);
	SET_VECTOR_ELT(sOUT,120,sGuidelines_Death_500_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,121,sGuidelines_Death_500_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,122,sGuidelines_Death_500_OffArt);
	SET_VECTOR_ELT(sOUT,123,sGuidelines_Death_350500_NeverDiag);
	SET_VECTOR_ELT(sOUT,124,sGuidelines_Death_350500_DiagNotInCare);
	SET_VECTOR_ELT(sOUT,125,sGuidelines_Death_350500_InCareNeverArt);
	SET_VECTOR_ELT(sOUT,126,sGuidelines_Death_350500_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,127,sGuidelines_Death_350500_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,128,sGuidelines_Death_350500_OffArt);
	SET_VECTOR_ELT(sOUT,129,sGuidelines_Death_200350_NeverDiag);
	SET_VECTOR_ELT(sOUT,130,sGuidelines_Death_200350_DiagNotInCare);
	SET_VECTOR_ELT(sOUT,131,sGuidelines_Death_200350_InCareNeverArt);
	SET_VECTOR_ELT(sOUT,132,sGuidelines_Death_200350_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,133,sGuidelines_Death_200350_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,134,sGuidelines_Death_200350_OffArt);
	SET_VECTOR_ELT(sOUT,135,sGuidelines_Death_200_NeverDiag);
	SET_VECTOR_ELT(sOUT,136,sGuidelines_Death_200_DiagNotInCare);
	SET_VECTOR_ELT(sOUT,137,sGuidelines_Death_200_InCareNeverArt);
	SET_VECTOR_ELT(sOUT,138,sGuidelines_Death_200_ArtLessSixMonths);
	SET_VECTOR_ELT(sOUT,139,sGuidelines_Death_200_ArtMoreSixMonths);
	SET_VECTOR_ELT(sOUT,140,sGuidelines_Death_200_OffArt);
	SET_VECTOR_ELT(sOUT,141,sGuidelines_Art_500);
	SET_VECTOR_ELT(sOUT,142,sGuidelines_Art_350500);
	SET_VECTOR_ELT(sOUT,143,sGuidelines_Art_200350);
	SET_VECTOR_ELT(sOUT,144,sGuidelines_Art_200);
	SET_VECTOR_ELT(sOUT,145,sGuidelines_NewInfectionsAdult);
	SET_VECTOR_ELT(sOUT,146,sGuidelines_NewDiagnoses);
	...
	SET_VECTOR_ELT(sOUTNAMES,63,mkChar("sGuidelines_PopDist_HivNegative"));
	SET_VECTOR_ELT(sOUTNAMES,64,mkChar("sGuidelines_PopDist_500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,65,mkChar("sGuidelines_PopDist_500_DiagNotInCareNeverCare"));
	SET_VECTOR_ELT(sOUTNAMES,66,mkChar("sGuidelines_PopDist_500_DiagNotInCareNeverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,67,mkChar("sGuidelines_PopDist_500_DiagNotInCareEverCare"));
	SET_VECTOR_ELT(sOUTNAMES,68,mkChar("sGuidelines_PopDist_500_DiagNotInCareEverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,69,mkChar("sGuidelines_PopDist_500_InCareNeverArtNeverCd4Result"));
	SET_VECTOR_ELT(sOUTNAMES,70,mkChar("sGuidelines_PopDist_500_InCareNeverArtLessTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,71,mkChar("sGuidelines_PopDist_500_InCareNeverArtMoreTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,72,mkChar("sGuidelines_PopDist_500_ArtAtEnrollmentLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,73,mkChar("sGuidelines_PopDist_500_ArtAtEnrollmentMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,74,mkChar("sGuidelines_PopDist_500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,75,mkChar("sGuidelines_PopDist_500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,76,mkChar("sGuidelines_PopDist_500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,77,mkChar("sGuidelines_PopDist_350500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,78,mkChar("sGuidelines_PopDist_350500_DiagNotInCareNeverCare"));
	SET_VECTOR_ELT(sOUTNAMES,79,mkChar("sGuidelines_PopDist_350500_DiagNotInCareNeverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,80,mkChar("sGuidelines_PopDist_350500_DiagNotInCareEverCare"));
	SET_VECTOR_ELT(sOUTNAMES,81,mkChar("sGuidelines_PopDist_350500_DiagNotInCareEverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,82,mkChar("sGuidelines_PopDist_350500_InCareNeverArtNeverCd4Result"));
	SET_VECTOR_ELT(sOUTNAMES,83,mkChar("sGuidelines_PopDist_350500_InCareNeverArtLessTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,84,mkChar("sGuidelines_PopDist_350500_InCareNeverArtMoreTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,85,mkChar("sGuidelines_PopDist_350500_ArtAtEnrollmentLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,86,mkChar("sGuidelines_PopDist_350500_ArtAtEnrollmentMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,87,mkChar("sGuidelines_PopDist_350500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,88,mkChar("sGuidelines_PopDist_350500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,89,mkChar("sGuidelines_PopDist_350500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,90,mkChar("sGuidelines_PopDist_200350_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,91,mkChar("sGuidelines_PopDist_200350_DiagNotInCareNeverCare"));
	SET_VECTOR_ELT(sOUTNAMES,92,mkChar("sGuidelines_PopDist_200350_DiagNotInCareNeverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,93,mkChar("sGuidelines_PopDist_200350_DiagNotInCareEverCare"));
	SET_VECTOR_ELT(sOUTNAMES,94,mkChar("sGuidelines_PopDist_200350_DiagNotInCareEverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,95,mkChar("sGuidelines_PopDist_200350_InCareNeverArtNeverCd4Result"));
	SET_VECTOR_ELT(sOUTNAMES,96,mkChar("sGuidelines_PopDist_200350_InCareNeverArtLessTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,97,mkChar("sGuidelines_PopDist_200350_InCareNeverArtMoreTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,98,mkChar("sGuidelines_PopDist_200350_ArtAtEnrollmentLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,99,mkChar("sGuidelines_PopDist_200350_ArtAtEnrollmentMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,100,mkChar("sGuidelines_PopDist_200350_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,101,mkChar("sGuidelines_PopDist_200350_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,102,mkChar("sGuidelines_PopDist_200350_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,103,mkChar("sGuidelines_PopDist_200_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,104,mkChar("sGuidelines_PopDist_200_DiagNotInCareNeverCare"));
	SET_VECTOR_ELT(sOUTNAMES,105,mkChar("sGuidelines_PopDist_200_DiagNotInCareNeverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,106,mkChar("sGuidelines_PopDist_200_DiagNotInCareEverCare"));
	SET_VECTOR_ELT(sOUTNAMES,107,mkChar("sGuidelines_PopDist_200_DiagNotInCareEverCareEligible"));
	SET_VECTOR_ELT(sOUTNAMES,108,mkChar("sGuidelines_PopDist_200_InCareNeverArtNeverCd4Result"));
	SET_VECTOR_ELT(sOUTNAMES,109,mkChar("sGuidelines_PopDist_200_InCareNeverArtLessTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,110,mkChar("sGuidelines_PopDist_200_InCareNeverArtMoreTwoCd4Test"));
	SET_VECTOR_ELT(sOUTNAMES,111,mkChar("sGuidelines_PopDist_200_ArtAtEnrollmentLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,112,mkChar("sGuidelines_PopDist_200_ArtAtEnrollmentMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,113,mkChar("sGuidelines_PopDist_200_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,114,mkChar("sGuidelines_PopDist_200_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,115,mkChar("sGuidelines_PopDist_200_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,116,mkChar("sGuidelines_Death_HivNegative"));
	SET_VECTOR_ELT(sOUTNAMES,117,mkChar("sGuidelines_Death_500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,118,mkChar("sGuidelines_Death_500_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,119,mkChar("sGuidelines_Death_500_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,120,mkChar("sGuidelines_Death_500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,121,mkChar("sGuidelines_Death_500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,122,mkChar("sGuidelines_Death_500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,123,mkChar("sGuidelines_Death_350500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,124,mkChar("sGuidelines_Death_350500_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,125,mkChar("sGuidelines_Death_350500_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,126,mkChar("sGuidelines_Death_350500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,127,mkChar("sGuidelines_Death_350500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,128,mkChar("sGuidelines_Death_350500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,129,mkChar("sGuidelines_Death_200350_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,130,mkChar("sGuidelines_Death_200350_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,131,mkChar("sGuidelines_Death_200350_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,132,mkChar("sGuidelines_Death_200350_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,133,mkChar("sGuidelines_Death_200350_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,134,mkChar("sGuidelines_Death_200350_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,135,mkChar("sGuidelines_Death_200_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,136,mkChar("sGuidelines_Death_200_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,137,mkChar("sGuidelines_Death_200_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,138,mkChar("sGuidelines_Death_200_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,139,mkChar("sGuidelines_Death_200_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,140,mkChar("sGuidelines_Death_200_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,141,mkChar("sGuidelines_Art_500"));
	SET_VECTOR_ELT(sOUTNAMES,142,mkChar("sGuidelines_Art_350500"));
	SET_VECTOR_ELT(sOUTNAMES,143,mkChar("sGuidelines_Art_200350"));
	SET_VECTOR_ELT(sOUTNAMES,144,mkChar("sGuidelines_Art_200"));
	SET_VECTOR_ELT(sOUTNAMES,145,mkChar("sGuidelines_NewInfectionsAdult"));
	SET_VECTOR_ELT(sOUTNAMES,146,mkChar("sGuidelines_NewDiagnoses"));
	SET_VECTOR_ELT(sOUTNAMES,147,mkChar("sGuidelines_PreArtDropout"));
	SET_VECTOR_ELT(sOUTNAMES,148,mkChar("sGuidelines_ArtDropout"));
