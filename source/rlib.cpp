...
SEXP CallCascade(SEXP s_pop,
	...
	SET_VECTOR_ELT(sOUTNAMES,65,mkChar("sGuidelines_PopDist_500_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,66,mkChar("sGuidelines_PopDist_500_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,67,mkChar("sGuidelines_PopDist_500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,68,mkChar("sGuidelines_PopDist_500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,69,mkChar("sGuidelines_PopDist_500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,70,mkChar("sGuidelines_PopDist_350500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,71,mkChar("sGuidelines_PopDist_350500_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,72,mkChar("sGuidelines_PopDist_350500_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,73,mkChar("sGuidelines_PopDist_350500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,74,mkChar("sGuidelines_PopDist_350500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,75,mkChar("sGuidelines_PopDist_350500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,76,mkChar("sGuidelines_PopDist_200350_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,77,mkChar("sGuidelines_PopDist_200350_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,78,mkChar("sGuidelines_PopDist_200350_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,79,mkChar("sGuidelines_PopDist_200350_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,80,mkChar("sGuidelines_PopDist_200350_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,81,mkChar("sGuidelines_PopDist_200350_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,82,mkChar("sGuidelines_PopDist_200_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,83,mkChar("sGuidelines_PopDist_200_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,84,mkChar("sGuidelines_PopDist_200_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,85,mkChar("sGuidelines_PopDist_200_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,86,mkChar("sGuidelines_PopDist_200_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,87,mkChar("sGuidelines_PopDist_200_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,88,mkChar("sGuidelines_Death_HivNegative"));
	SET_VECTOR_ELT(sOUTNAMES,89,mkChar("sGuidelines_Death_500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,90,mkChar("sGuidelines_Death_500_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,91,mkChar("sGuidelines_Death_500_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,92,mkChar("sGuidelines_Death_500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,93,mkChar("sGuidelines_Death_500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,94,mkChar("sGuidelines_Death_500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,95,mkChar("sGuidelines_Death_350500_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,96,mkChar("sGuidelines_Death_350500_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,97,mkChar("sGuidelines_Death_350500_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,98,mkChar("sGuidelines_Death_350500_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,99,mkChar("sGuidelines_Death_350500_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,100,mkChar("sGuidelines_Death_350500_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,101,mkChar("sGuidelines_Death_200350_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,102,mkChar("sGuidelines_Death_200350_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,103,mkChar("sGuidelines_Death_200350_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,104,mkChar("sGuidelines_Death_200350_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,105,mkChar("sGuidelines_Death_200350_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,106,mkChar("sGuidelines_Death_200350_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,107,mkChar("sGuidelines_Death_200_NeverDiag"));
	SET_VECTOR_ELT(sOUTNAMES,108,mkChar("sGuidelines_Death_200_DiagNotInCare"));
	SET_VECTOR_ELT(sOUTNAMES,109,mkChar("sGuidelines_Death_200_InCareNeverArt"));
	SET_VECTOR_ELT(sOUTNAMES,110,mkChar("sGuidelines_Death_200_ArtLessSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,111,mkChar("sGuidelines_Death_200_ArtMoreSixMonths"));
	SET_VECTOR_ELT(sOUTNAMES,112,mkChar("sGuidelines_Death_200_OffArt"));
	SET_VECTOR_ELT(sOUTNAMES,113,mkChar("sGuidelines_Art_500"));
	SET_VECTOR_ELT(sOUTNAMES,114,mkChar("sGuidelines_Art_350500"));
	SET_VECTOR_ELT(sOUTNAMES,115,mkChar("sGuidelines_Art_200350"));
	SET_VECTOR_ELT(sOUTNAMES,116,mkChar("sGuidelines_Art_200"));
	SET_VECTOR_ELT(sOUTNAMES,117,mkChar("sGuidelines_NewInfectionsAdult"));
	SET_VECTOR_ELT(sOUTNAMES,118,mkChar("sGuidelines_NewDiagnoses"));
	SET_VECTOR_ELT(sOUTNAMES,119,mkChar("sGuidelines_PreArtDropout"));
	SET_VECTOR_ELT(sOUTNAMES,120,mkChar("sGuidelines_ArtDropout"));
