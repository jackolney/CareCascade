...
/* Probability of attending Cd4 Test result visit */ // og = 0.9486833
double cd4ResultProbAttend = 0.9899495;

/* Pre-Art retention probability (between test and result) */
double hctShortTermRetention = 0.9899495;
double hctLongTermRetention = 0.9899495;

double vctShortTermRetention = 0.9899495;
double vctLongTermRetention = 0.9899495;

double pictShortTermRetention = 0.9899495;
double pictLongTermRetention = 0.9899495;

/* Proportion returning for secondary Cd4 testing  */ // og = 0.75
double hctProbSecondaryCd4Test = 0.98;
double vctProbSecondaryCd4Test = 0.98;
double pictProbSecondaryCd4Test = 0.98;
