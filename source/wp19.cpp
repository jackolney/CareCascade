...
int * theGuidelines_PopDist_500_DiagNotInCareNeverCareEligible;
int * theGuidelines_PopDist_500_DiagNotInCareEverCare;
int * theGuidelines_PopDist_500_DiagNotInCareEverCareEligible;
int * theGuidelines_PopDist_500_InCareNeverArtNeverCd4Result;
int * theGuidelines_PopDist_500_InCareNeverArtLessTwoCd4Test;
int * theGuidelines_PopDist_500_InCareNeverArtMoreTwoCd4Test;
int * theGuidelines_PopDist_500_ArtAtEnrollmentLessSixMonths;
int * theGuidelines_PopDist_500_ArtAtEnrollmentMoreSixMonths;
...
int * theGuidelines_PopDist_350500_DiagNotInCareNeverCareEligible;
int * theGuidelines_PopDist_350500_DiagNotInCareEverCare;
int * theGuidelines_PopDist_350500_DiagNotInCareEverCareEligible;
int * theGuidelines_PopDist_350500_InCareNeverArtNeverCd4Result;
int * theGuidelines_PopDist_350500_InCareNeverArtLessTwoCd4Test;
int * theGuidelines_PopDist_350500_InCareNeverArtMoreTwoCd4Test;
int * theGuidelines_PopDist_350500_ArtAtEnrollmentLessSixMonths;
int * theGuidelines_PopDist_350500_ArtAtEnrollmentMoreSixMonths;
...
int * theGuidelines_PopDist_200350_DiagNotInCareNeverCareEligible;
int * theGuidelines_PopDist_200350_DiagNotInCareEverCare;
int * theGuidelines_PopDist_200350_DiagNotInCareEverCareEligible;
int * theGuidelines_PopDist_200350_InCareNeverArtNeverCd4Result;
int * theGuidelines_PopDist_200350_InCareNeverArtLessTwoCd4Test;
int * theGuidelines_PopDist_200350_InCareNeverArtMoreTwoCd4Test;
int * theGuidelines_PopDist_200350_ArtAtEnrollmentLessSixMonths;
int * theGuidelines_PopDist_200350_ArtAtEnrollmentMoreSixMonths;
...
int * theGuidelines_PopDist_200_DiagNotInCareNeverCareEligible;
int * theGuidelines_PopDist_200_DiagNotInCareEverCare;
int * theGuidelines_PopDist_200_DiagNotInCareEverCareEligible;
int * theGuidelines_PopDist_200_InCareNeverArtNeverCd4Result;
int * theGuidelines_PopDist_200_InCareNeverArtLessTwoCd4Test;
int * theGuidelines_PopDist_200_InCareNeverArtMoreTwoCd4Test;
int * theGuidelines_PopDist_200_ArtAtEnrollmentLessSixMonths;
int * theGuidelines_PopDist_200_ArtAtEnrollmentMoreSixMonths;
...
void CreateGuidelinesArray()
{
	...
	theGuidelines_PopDist_500_DiagNotInCareNeverCareEligible = new int[36];
	theGuidelines_PopDist_500_DiagNotInCareEverCare = new int[36];
	theGuidelines_PopDist_500_DiagNotInCareEverCareEligible = new int[36];
	theGuidelines_PopDist_500_InCareNeverArtNeverCd4Result = new int[36];
	theGuidelines_PopDist_500_InCareNeverArtLessTwoCd4Test = new int[36];
	theGuidelines_PopDist_500_InCareNeverArtMoreTwoCd4Test = new int[36];
	theGuidelines_PopDist_500_ArtAtEnrollmentLessSixMonths = new int[36];
	theGuidelines_PopDist_500_ArtAtEnrollmentMoreSixMonths = new int[36];
	...
	theGuidelines_PopDist_350500_DiagNotInCareNeverCareEligible = new int[36];
	theGuidelines_PopDist_350500_DiagNotInCareEverCare = new int[36];
	theGuidelines_PopDist_350500_DiagNotInCareEverCareEligible = new int[36];
	theGuidelines_PopDist_350500_InCareNeverArtNeverCd4Result = new int[36];
	theGuidelines_PopDist_350500_InCareNeverArtLessTwoCd4Test = new int[36];
	theGuidelines_PopDist_350500_InCareNeverArtMoreTwoCd4Test = new int[36];
	theGuidelines_PopDist_350500_ArtAtEnrollmentLessSixMonths = new int[36];
	theGuidelines_PopDist_350500_ArtAtEnrollmentMoreSixMonths = new int[36];
	...
	theGuidelines_PopDist_200350_DiagNotInCareNeverCareEligible = new int[36];
	theGuidelines_PopDist_200350_DiagNotInCareEverCare = new int[36];
	theGuidelines_PopDist_200350_DiagNotInCareEverCareEligible = new int[36];
	theGuidelines_PopDist_200350_InCareNeverArtNeverCd4Result = new int[36];
	theGuidelines_PopDist_200350_InCareNeverArtLessTwoCd4Test = new int[36];
	theGuidelines_PopDist_200350_InCareNeverArtMoreTwoCd4Test = new int[36];
	theGuidelines_PopDist_200350_ArtAtEnrollmentLessSixMonths = new int[36];
	theGuidelines_PopDist_200350_ArtAtEnrollmentMoreSixMonths = new int[36];
	...
	theGuidelines_PopDist_200_DiagNotInCareNeverCareEligible = new int[36];
	theGuidelines_PopDist_200_DiagNotInCareEverCare = new int[36];
	theGuidelines_PopDist_200_DiagNotInCareEverCareEligible = new int[36];
	theGuidelines_PopDist_200_InCareNeverArtNeverCd4Result = new int[36];
	theGuidelines_PopDist_200_InCareNeverArtLessTwoCd4Test = new int[36];
	theGuidelines_PopDist_200_InCareNeverArtMoreTwoCd4Test = new int[36];
	theGuidelines_PopDist_200_ArtAtEnrollmentLessSixMonths = new int[36];
	theGuidelines_PopDist_200_ArtAtEnrollmentMoreSixMonths = new int[36];	
	...
	for(size_t i=0;i<36;i++) {
		...
		theGuidelines_PopDist_500_DiagNotInCareNeverCareEligible[i] = 0;
		theGuidelines_PopDist_500_DiagNotInCareEverCare[i] = 0;
		theGuidelines_PopDist_500_DiagNotInCareEverCareEligible[i] = 0;
		theGuidelines_PopDist_500_InCareNeverArtNeverCd4Result[i] = 0;
		theGuidelines_PopDist_500_InCareNeverArtLessTwoCd4Test[i] = 0;
		theGuidelines_PopDist_500_InCareNeverArtMoreTwoCd4Test[i] = 0;
		theGuidelines_PopDist_500_ArtAtEnrollmentLessSixMonths[i] = 0;
		theGuidelines_PopDist_500_ArtAtEnrollmentMoreSixMonths[i] = 0;
		...
		theGuidelines_PopDist_350500_DiagNotInCareNeverCareEligible[i] = 0;
		theGuidelines_PopDist_350500_DiagNotInCareEverCare[i] = 0;
		theGuidelines_PopDist_350500_DiagNotInCareEverCareEligible[i] = 0;
		theGuidelines_PopDist_350500_InCareNeverArtNeverCd4Result[i] = 0;
		theGuidelines_PopDist_350500_InCareNeverArtLessTwoCd4Test[i] = 0;
		theGuidelines_PopDist_350500_InCareNeverArtMoreTwoCd4Test[i] = 0;
		theGuidelines_PopDist_350500_ArtAtEnrollmentLessSixMonths[i] = 0;
		theGuidelines_PopDist_350500_ArtAtEnrollmentMoreSixMonths[i] = 0;
		...
		theGuidelines_PopDist_200350_DiagNotInCareNeverCareEligible[i] = 0;
		theGuidelines_PopDist_200350_DiagNotInCareEverCare[i] = 0;
		theGuidelines_PopDist_200350_DiagNotInCareEverCareEligible[i] = 0;
		theGuidelines_PopDist_200350_InCareNeverArtNeverCd4Result[i] = 0;
		theGuidelines_PopDist_200350_InCareNeverArtLessTwoCd4Test[i] = 0;
		theGuidelines_PopDist_200350_InCareNeverArtMoreTwoCd4Test[i] = 0;
		theGuidelines_PopDist_200350_ArtAtEnrollmentLessSixMonths[i] = 0;
		theGuidelines_PopDist_200350_ArtAtEnrollmentMoreSixMonths[i] = 0;		
		...
		theGuidelines_PopDist_200_DiagNotInCareNeverCareEligible[i] = 0;
		theGuidelines_PopDist_200_DiagNotInCareEverCare[i] = 0;
		theGuidelines_PopDist_200_DiagNotInCareEverCareEligible[i] = 0;
		theGuidelines_PopDist_200_InCareNeverArtNeverCd4Result[i] = 0;
		theGuidelines_PopDist_200_InCareNeverArtLessTwoCd4Test[i] = 0;
		theGuidelines_PopDist_200_InCareNeverArtMoreTwoCd4Test[i] = 0;
		theGuidelines_PopDist_200_ArtAtEnrollmentLessSixMonths[i] = 0;
		theGuidelines_PopDist_200_ArtAtEnrollmentMoreSixMonths[i] = 0;		
