...
lines(seq(20,43,1),Unaids_HivPrev$prev,
	...
	lty=3,
	col=p[1])
lines(seq(0,59,1),result$sHIV_15to49 / result$sPOP_15to49,
	lwd=4,
	col=p[2])
...
lines(seq(34,42,1),Unaids_PlwhivOnArt$propPlwhivOnArt,
	...
	lty=3,
	col=p[1])
lines(seq(0,59,1),result$sART_15to49 / result$sHIV_15to49,
	lwd=4,
	col=p[2])
axis(1,seq(0,60,5),seq(1970,2030,5))
...
lines(seq(20,43,1),Unaids_AidsDeaths$proportion,
	...
	lty=3,
	col=p[1])
lines(seq(1,60,1),(result$sAidsDeath_15plus / result$sPOP_15plus)[1:60],
	lwd=4,
	col=p[2])
axis(1,seq(0,60,5),seq(1970,2030,5))
legend("topright",c("UNAIDS","CareCascade"),
